...
public class TScanOpenParams implements org.apache.thrift.TBase<TScanOpenParams, TScanOpenParams._Fields>, java.io.Serializable, Cloneable, Comparable<TScanOpenParams> {
  ...
  public @org.apache.thrift.annotation.Nullable String cluster; // required
  ...
  public @org.apache.thrift.annotation.Nullable java.util.List<Long> tablet_ids; // required
  public @org.apache.thrift.annotation.Nullable String opaqued_query_plan; // required
  ...
  public @org.apache.thrift.annotation.Nullable String user; // optional
  public @org.apache.thrift.annotation.Nullable String passwd; // optional
  ...
  public TScanOpenParams(
    ...
    String database,
    String table,
    java.util.List<Long> tablet_ids,
  ...
  public TScanOpenParams(TScanOpenParams other) {
    ...
    if (other.isSetTablet_ids()) {
      java.util.List<Long> __this__tablet_ids = new java.util.ArrayList<Long>(other.tablet_ids);
  ...
  public TScanOpenParams setCluster(@org.apache.thrift.annotation.Nullable String cluster) {
    this.cluster = cluster;
    return this;
  }
  ...
  public TScanOpenParams setDatabase(@org.apache.thrift.annotation.Nullable String database) {
    this.database = database;
    return this;
  }
  ...
  public TScanOpenParams setTable(@org.apache.thrift.annotation.Nullable String table) {
    this.table = table;
    return this;
  }
  ...
  public void addToTablet_ids(long elem) {
    if (this.tablet_ids == null) {
      this.tablet_ids = new java.util.ArrayList<Long>();
    }
    this.tablet_ids.add(elem);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.List<Long> getTablet_ids() {
    return this.tablet_ids;
  }

  public TScanOpenParams setTablet_ids(@org.apache.thrift.annotation.Nullable java.util.List<Long> tablet_ids) {
    this.tablet_ids = tablet_ids;
    return this;
  }
  ...
  public TScanOpenParams setOpaqued_query_plan(@org.apache.thrift.annotation.Nullable String opaqued_query_plan) {
    this.opaqued_query_plan = opaqued_query_plan;
    return this;
  }
  ...
  public TScanOpenParams setProperties(@org.apache.thrift.annotation.Nullable java.util.Map<String, String> properties) {
  ...
  public TScanOpenParams setUser(@org.apache.thrift.annotation.Nullable String user) {
    this.user = user;
    return this;
  }
  ...
  public TScanOpenParams setPasswd(@org.apache.thrift.annotation.Nullable String passwd) {
    this.passwd = passwd;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable Object value) {
    ...
    case TABLET_IDS:
      if (value == null) {
        ...
        setTablet_ids((java.util.List<Long>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tablet_ids = new java.util.ArrayList<Long>(_list0.size);
                long _elem1;
  ...
  private static class TScanOpenParamsTupleScheme extends org.apache.thrift.scheme.TupleScheme<TScanOpenParams> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TScanOpenParams struct) throws org.apache.thrift.TException {
      ...
      struct.setTableIsSet(true);
      {
        ...
        struct.tablet_ids = new java.util.ArrayList<Long>(_list11.size);
        long _elem12;
